...
The grid used for the three-dimensional simulation contains about $46$ million cells and is somewhat coarse for direct numerical simulation at Reynolds number $2,000$, but acceptable for our exploratory analysis.
